...
class _InceptionResnetV1_backbone(nn.Module):
    def __init__(self):
        super(_InceptionResnetV1_backbone,self).__init__()
...
@register_model('incv1_adaptive')
class InceptionResnetV1_adaptive(BaseImageClassifier):
    ...
    def _forward_impl(self, image: torch.Tensor, *args, **kwargs):
        feature = self.flatten(self.model(image))
