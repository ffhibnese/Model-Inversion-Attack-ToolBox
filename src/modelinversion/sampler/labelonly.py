...
class LabelOnlySelectLatentsSampler(SimpleLatentsSampler):
    ...
    def __init__(self, input_size: int | Sequence[int], batch_size: int, generator: BaseImageGenerator, classifier: BaseImageClassifier, device: torch.device, latents_mapping: Optional[Callable] = None, image_transform: Optional[Callable[[Tensor], Tensor]] = None, max_iters: int = 100000) -> None:
