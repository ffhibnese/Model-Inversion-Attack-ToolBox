...
class Optimizer(object):
    def __init__(self, eva_model, generator, target_label, nv=15, beta=0.04,
...
class DE_c2b_5_bin2(object):
    ...
    def get_best_latent(self):
        return self.pop[self.bestID:self.bestID+1]
