...
class LoktAttacker(PLGMIAttacker):
    ...
    def prepare_attack(self):
        ...
        for S_name in config.surrogate_names:
            ...
            folder_manager.load_state_dict(surrogate_model, ['lokt', f'{self.config.target_dataset_name}_{self.config.target_name}_{self.config.defense_type}.pt'], device=config.device)
