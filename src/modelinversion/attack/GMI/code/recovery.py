...
def get_iden_loss(
    ...
    labels,
    T: BaseTargetModel,
    augment_models: list[BaseTargetModel] = None,
    use_logit_loss=False,
    T_feature_means=None,
    T_feature_stds=None,
    reg_coef=0.1,
):
    ...
    if T_feature_means is not None and T_feature_stds is not None:
        reg_loss += reg_coef * get_reg_loss(
            T_res.feat[-1], T_feature_means, T_feature_stds
        )
