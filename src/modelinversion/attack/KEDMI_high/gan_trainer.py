...
class KedmiGANTrainer(BaseGANTrainer):
    ...
    def get_tag(self) -> str:
        args = self.args
        return f'kedmi_high_{args.dataset_name}'
    ...
    def prepare_training(self):
        ...
        self.D = (MinibatchDiscriminator(n_classes=530)).to(args.device)
    ...
    def train_gen_step(self, batch) -> OrderedDict:
        ...
        entropy_loss = - (F.softmax(dis_fake, dim=-1) * F.log_softmax(dis_fake, dim=-1)).sum()
