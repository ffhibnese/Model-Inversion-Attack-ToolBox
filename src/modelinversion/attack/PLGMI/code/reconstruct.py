...
def inversion(
    ...
    for random_seed in range(num_seeds):
        ...
        z = utils.sample_z(bs, args.gen_dim_z, args.device, args.gen_distribution)
        ...
        for i in range(iter_times):
            ...
            if args.inv_loss_type == 'ce':
                inv_loss = L.cross_entropy_loss(out1, iden) + L.cross_entropy_loss(
                    out2, iden
                )
