...
from modelinversion.attack.KEDMI_high.gan_trainer import KedmiGANTrainArgs, KedmiGANTrainer
...
if __name__ == '__main__':
    ...
    trainer = KedmiGANTrainer(train_args, folder_manager)
