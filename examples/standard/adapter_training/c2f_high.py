...
if __name__ == '__main__':
    ...
    target_model_ckpt_path = '/data/yhy/Model-Inversion-Attack-ToolBox/checkpoints_v2/classifier/facescrub224/facescrub224_resnet152_92.25.pth'
    embed_model_ckpt_path = '/data/yhy/Model-Inversion-Attack-ToolBox/checkpoints_v2/attacks/c2f/embedder/casia_incv1.pth'
    dataset_path = '/data/yhy/Model-Inversion-Attack-ToolBox/dataset/ffhq256'
