...
if __name__ == '__main__':
    ...
    optimize_create_aug_images_fn = augment_images_fn_generator(
        ...
        augment=RandomResizedCrop((target_resolution, target_resolution), scale=(0.9, 1.0), ratio=(1.0, 1.0), antialias=True),
        augment_times=1
    )
    ...
    optimization_fn = ImageAugmentWhiteBoxOptimization(optimization_config, generator, target_model, eval_model)
    ...
    final_create_aug_images_fn = augment_images_fn_generator(
        ...
        add_origin_image=False,
        augment=Compose([
            RandomResizedCrop((target_resolution, target_resolution), scale=(0.5, 0.9), ratio=(0.8, 1.2), antialias=True),
    ...
    final_select_score_fn = ImageClassificationAugmentConfidence(
        target_model,
        device=device,
        create_aug_images_fn=final_create_aug_images_fn
    )
