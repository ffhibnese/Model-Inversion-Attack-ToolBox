...
if __name__ == '__main__':
    ...
    target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_facescrub64/result_classifier/train_facescrub64_ir152_bd/facescrub64_ir152_bd.pth'
