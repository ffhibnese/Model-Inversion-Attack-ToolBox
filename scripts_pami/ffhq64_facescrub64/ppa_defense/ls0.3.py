...
if __name__ == '__main__':
    ...
    loradim = 1
    experiment_dir = f'./ppa_ir152_ls0.3'
    ...
    target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_facescrub64/result_classifier/train_facescrub64_ir152_ls_-0.3/facescrub64_ir152_ls_-0.3.pth'
