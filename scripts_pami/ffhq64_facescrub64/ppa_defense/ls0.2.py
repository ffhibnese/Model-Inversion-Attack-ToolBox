...
if __name__ == '__main__':
    ...
    loradim = 1
    experiment_dir = f'./ppa_ir152_ls0.2'
    ...
    target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_facescrub64/result_classifier/train_facescrub64_ir152_ls_-0.2/facescrub64_ir152_ls_-0.2.pth'
    ...
    optimize_batch_size = 15
    final_selection_batch_size = 15
