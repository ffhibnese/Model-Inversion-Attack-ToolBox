...
if __name__ == '__main__':
    ...
    num_classes = 530
    target_model_ckpt_path = f'../result_classifier/train_facescrub64_ir152_tl0.4/facescrub64_ir152_tl0.4.pth'
    dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/ffhq64'
    experiment_dir = './results_gan/kedmi_ffhq64_facescrub64_ir152_tl0.4_gan'
