...
if __name__ == '__main__':
    ...
    tag = 'ls0.3'
    experiment_dir = f'./kedmi_ir152_{tag}_100'
    device_ids_str = '1'
    num_classes = 530
    generator_ckpt_path = (
        f'./results_gan/kedmi_ffhq64_facescrub64_ir152_{tag}_gan/G.pth'
    )
    discriminator_ckpt_path = (
        f'./results_gan/kedmi_ffhq64_facescrub64_ir152_{tag}_gan/D.pth'
    )
    ...
    #     generator, select_classes=list(range(100)), description='alt100', device=device
    # )
