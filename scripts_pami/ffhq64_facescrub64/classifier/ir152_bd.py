...
if __name__ == '__main__':
    ...
    model_name = 'ir152'
    # ls_val = -0.2
    save_name = f'facescrub64_{model_name}_bd.pth'
    dataset_path = '/data/<usrname>/intermediate-MIA/intermediate-MIA/data/facescrub'
    experiment_dir = f'../result_classifier/train_facescrub64_{model_name}_bd'
    ...
    trainer = BackdoorTrainer(config)
