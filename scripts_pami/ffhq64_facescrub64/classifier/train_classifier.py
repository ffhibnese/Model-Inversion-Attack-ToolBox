...
celeba_high_path = None
celeba_low_path = None
...
no_defense_model_path = "/mnt/data/<usrname>/mywork/lora_defense/checkpoints_v2/classifier/facescrub64/facescrub64_ir152.pth"
