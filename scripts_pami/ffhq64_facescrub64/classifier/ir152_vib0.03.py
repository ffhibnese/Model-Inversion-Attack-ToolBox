...
from modelinversion.train import VibTrainer, VibTrainConfig
...
if __name__ == '__main__':
    ...
    model_name = 'ir152'
    vib_coef = 0.03
    save_name = f'facescrub64_{model_name}_vib{vib_coef}.pth'
    dataset_path = '/data/<usrname>/intermediate-MIA/intermediate-MIA/data/facescrub'
    experiment_dir = (
        f'../result_classifier/train_facescrub64_{model_name}_vib{vib_coef}'
    )
