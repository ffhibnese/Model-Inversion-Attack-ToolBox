...
from modelinversion.models import IR152_64, auto_classifier_from_pretrained
...
if __name__ == '__main__':
    ...
    model_name = 'ir152'
    focal_gamma = 3
    save_name = f'facescrub64_{model_name}_focal{focal_gamma}.pth'
    dataset_path = '/data/<usrname>/intermediate-MIA/intermediate-MIA/data/facescrub'
    experiment_dir = (
        f'../result_classifier/train_facescrub64_{model_name}_focal{focal_gamma}'
    )
    ...
    model = auto_classifier_from_pretrained(
        "/data/<usrname>/Model-Inversion-Attack-ToolBox/checkpoints_v2/classifier/facescrub64/facescrub64_ir152_98.25.pth"
    )
    ...
    loss_fn = InverseFocalLoss(gamma=focal_gamma)
