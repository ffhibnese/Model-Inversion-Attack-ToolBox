...
if __name__ == '__main__':
    ...
    num_classes = 530
    loradim = 1
    target_model_ckpt_path = f'../result_classifier/train_facescrub64_ir152_bido0.01_0.1/facescrub64_ir152_bido0.01_0.1.pth'
    src_dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/ffhq64'
    dst_dataset_path = f'./dataset/plg_ffhq64_facescrub64_ir152_bido0.01_0.1_dataset'
    experiment_dir = f'./results_gan/plg_ffhq64_facescrub64_ir152_bido0.01_0.1_gan'
