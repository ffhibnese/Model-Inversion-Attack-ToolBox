...
def main(tag):
    ...
    experiment_dir = f'./attack_result/black/smile_black_ir152_{tag}'
    ...
    target_model_ckpt_path = (
        f'./classifier/lokt_ffhq64_facescrub64_ir152_{tag}/ir152/facescrub64_ir152.pth'
    )
    ...
    target_model = auto_classifier_from_pretrained(
        target_model_ckpt_path, avg_result=True
    )
    ...
    to_eval_transform = Compose(
        [CenterCrop((176, 176)), Resize((eval_resolution, eval_resolution))]
    )
