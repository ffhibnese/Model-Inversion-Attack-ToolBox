...
def main(tag):
    ...
    experiment_dir = f'./results_attack/lommagmi_ir152_{tag}'
    device_ids_str = '3'
    num_classes = 530
    ...
    aug_model_efficientnet_b0_path = f'./surr/distill_ffhq64_efficientnet_b0_facescrub64_{tag}/ffhq64_efficientnet_b0_facescrub64_{tag}.pth'
    aug_model_efficientnet_b1_path = f'./surr/distill_ffhq64_efficientnet_b1_facescrub64_{tag}/ffhq64_efficientnet_b1_facescrub64_{tag}.pth'
    aug_model_efficientnet_b2_path = f'./surr/distill_ffhq64_efficientnet_b2_facescrub64_{tag}/ffhq64_efficientnet_b2_facescrub64_{tag}.pth'
    public_dataset_path = '/mnt/data/<usrname>/datasets/ffhq64'
