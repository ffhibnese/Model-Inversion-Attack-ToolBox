...
if __name__ == '__main__':
    ...
    teacher_name = 'ir152'
    save_name = f'ffhq64_{model_name}_facescrub64_{teacher_name}_ls0.3.pth'
    ...
    experiment_dir = f'./distill_ffhq64_{model_name}_facescrub64_{teacher_name}_ls0.3'
    teacher_ckpt_path = f'../../result_classifier/train_facescrub64_ir152_ls_-0.3/facescrub64_ir152_ls_-0.3.pth'
