...
if __name__ == '__main__':
    ...
    teacher_name = 'ir152'
    save_name = f'ffhq64_{model_name}_facescrub64_{teacher_name}_tl0.5.pth'
    ...
    experiment_dir = f'./distill_ffhq64_{model_name}_facescrub64_{teacher_name}_tl0.5'
    teacher_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/checkpoints_v2/classifier/facescrub64/facescrub64_ir152_tl_0.5_95.36.pth'
