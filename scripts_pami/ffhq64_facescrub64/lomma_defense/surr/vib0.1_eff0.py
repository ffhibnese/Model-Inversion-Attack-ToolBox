...
if __name__ == '__main__':
    ...
    teacher_name = 'ir152'
    save_name = f'ffhq64_{model_name}_facescrub64_{teacher_name}_vib0.1.pth'
    ...
    experiment_dir = f'./distill_ffhq64_{model_name}_facescrub64_{teacher_name}_vib0.1'
    teacher_ckpt_path = f'../../result_classifier/train_facescrub64_ir152_vib0.1/facescrub64_ir152_vib0.1.pth'
