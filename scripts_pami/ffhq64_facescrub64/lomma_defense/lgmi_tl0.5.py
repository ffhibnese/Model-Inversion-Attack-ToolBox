...
if __name__ == '__main__':
    ...
    target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/checkpoints_v2/classifier/facescrub64/facescrub64_ir152_bido_ih0.01_oh0.1_tl_0.5_93.66.pth'
