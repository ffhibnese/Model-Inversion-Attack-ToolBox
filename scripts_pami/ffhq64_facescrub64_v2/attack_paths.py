"""
Unified path configuration for all attacks in ffhq64_facescrub64_v2.
...
EXP_SETTING_ROOT = f'{RESP_ROOT}/test_lora/ffhq64_facescrub64'
DATASET_ROOT = f'/mnt/data/{_USR}/datasets'

# Target model: IR152 @ 64x64 (FaceScrub64)
_TARGET_MODEL_PATH = f'{EXP_SETTING_ROOT}/result_classifier/train_facescrub64_ir152{{tag}}/facescrub64_ir152{{tag}}.pth'
# Eval model: FaceNet112 @ 112x112
_EVAL_MODEL_PATH = f'{RESP_ROOT}/checkpoints_v2/classifier/facescrub112/facescrub112_facenet112_99.38.pth'
...
# GMI GAN at 64x64
_GMI_GAN_PATH = f'{RESP_ROOT}/checkpoints_v2/gmi/gmi_ffhq64'

# GAN training dataset
_DATASET_PATH = f'{DATASET_ROOT}/ffhq64'
...
class AttackPaths:
    ...
    # P2I-specific
    p2i_adapter_path: Optional[str] = None
    p2i_real_dataset_path: Optional[str] = None
    p2i_fake_dataset_path: Optional[str] = None
...
def _build_lomma_aug_model_paths(tag: str) -> List[str]:
    ...
    return [
        f'./results_attack/distill_efficientnet_b0_ir152_{tag}/ffhq64_efficientnet_b0_facescrub64_{tag}.pth',
        f'./results_attack/distill_efficientnet_b1_ir152_{tag}/ffhq64_efficientnet_b1_facescrub64_{tag}.pth',
        f'./results_attack/distill_efficientnet_b2_ir152_{tag}/ffhq64_efficientnet_b2_facescrub64_{tag}.pth',
    ]
...
def get_attack_paths(name: str, tag: str) -> AttackPaths:
    ...
    Args:
        name: Attack name ('c2f', 'gmi', 'if', 'ked', 'lokt', 'lomma_lgmi',
              'lomma_lked', 'mb', 'mirror', 'plg', 'ppa', 'ppdg', 'brep', 'smile')
    ...
    if name == 'c2f':
        ...
        base.c2f_pred_mapping_ckpt_path = (
            f'./results_mapping/c2f/ffhq64_facescrub64/ir152{tag_str}/mapping.pth'
        )
    ...
    # -------------------------------------------------------------------------
        ...
        base.generator_ckpt_path = (
            f'./results_gan/plg_ffhq64_facescrub64_resnet152{tag_str}_gan/G.pth'
        )
        base.gan_experiment_dir = (
            f'./results_gan/plg_ffhq64_facescrub64_resnet152{tag_str}_gan'
        )
    ...
    # -------------------------------------------------------------------------
        ...
        base.generator_ckpt_path = (
            f'./gan/lokt_ffhq64_facescrub64_ir152{tag_str}_gan/G.pth'
        )
        base.gan_experiment_dir = (
            f'./gan/lokt_ffhq64_facescrub64_ir152{tag_str}_gan'
        )
        base.lokt_aug_model_ckpt_paths = [
            f'./classifier/lokt_ffhq64_facescrub64_ir152{tag_str}/densenet121/facescrub64_densenet121.pth',
            f'./classifier/lokt_ffhq64_facescrub64_ir152{tag_str}/densenet161/facescrub64_densenet161.pth',
            f'./classifier/lokt_ffhq64_facescrub64_ir152{tag_str}/densenet169/facescrub64_densenet169.pth',
        ]
        base.lokt_dataset_path = _DATASET_PATH
        base.lokt_train_dataset_path = (
            f'./dataset/lokt_ffhq64_facescrub64_ir152{tag_str}_dataset/dataset.pt'
        )
    ...
    # -------------------------------------------------------------------------
    # SMILE: direct StyleGAN attack, no prerequisites
    # -------------------------------------------------------------------------
    elif name == 'smile':
        base.attack_file = 'att.py'
        base.prerequisites = []
        base.experiment_dir = f'./attack_result/white/smile_white_ir152{tag_str}'
        base.stylegan2ada_path = _STYLEGAN2ADA_PATH
        base.stylegan2ada_ckpt_path = _STYLEGAN2ADA_CKPT_PATH
        return base

    # -------------------------------------------------------------------------
    # SMILE BLACK: black-box StyleGAN attack, no prerequisites
    # -------------------------------------------------------------------------
    elif name == 'smile_black':
        base.attack_file = 'att_black.py'
        base.prerequisites = []
        base.experiment_dir = f'./attack_result/black/smile_black_ir152{tag_str}'
        base.stylegan2ada_path = _STYLEGAN2ADA_PATH
        base.stylegan2ada_ckpt_path = _STYLEGAN2ADA_CKPT_PATH
        return base

    # -------------------------------------------------------------------------
    # P2I: requires ds_real.py -> ds_fake.py -> adapter.py first, then att.py
    # -------------------------------------------------------------------------
    elif name == 'p2i':
        base.attack_file = 'att.py'
        base.prerequisites = ['ds_real.py', 'ds_fake.py', 'adapter.py']
        base.experiment_dir = f'./attack_result2/p2i_ir152{tag_str}'
        base.p2i_adapter_path = f'./results_adapter2/ffhq64_facescrub64/ir152{tag_str}'
        base.stylegan2ada_path = _STYLEGAN2ADA_PATH
        base.stylegan2ada_ckpt_path = _STYLEGAN2ADA_CKPT_PATH
        base.p2i_real_dataset_path = f'./real_dataset/ffhq64_facescrub64_ir152{tag_str}_dataset'
        base.p2i_fake_dataset_path = f'./fake_dataset/ffhq64_facescrub64_ir152{tag_str}_dataset/dataset.pt'
        return base
    ...
    # -------------------------------------------------------------------------
        ...
        known_attacks = [
            ...
            'mb', 'mirror', 'plg', 'ppa', 'ppdg', 'brep', 'smile', 'smile_black', 'p2i'
        ]
        raise ValueError(
