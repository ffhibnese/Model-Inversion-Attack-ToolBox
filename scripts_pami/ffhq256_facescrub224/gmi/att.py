...
for tag in [
    ...
    experiment_dir = f'./results_attack/gmi_ir152_{tag}'
    ...
    if tag == 'no':
        ...
        tag = '_' + tag
    num_classes = 530
    generator_ckpt_path = '../../../checkpoints_v2/gmi/gmi_ffhq256_G.pth'
    discriminator_ckpt_path = '../../../checkpoints_v2/gmi/gmi_ffhq256_D.pth'
