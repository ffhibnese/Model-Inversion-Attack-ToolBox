...
def main(tag):
    ...
    experiment_dir = f'./ppa_ir152{tag}'
    ...
    target_model_ckpt_path = (
        f'../result_classifier/train_celeba64_ir152{tag}/celeba64_ir152{tag}.pth'
    )
...
if __name__ == '__main__':
    # for tag in ['neck50tanh', 'ls0.12', 'tl0.6', 'vib0.01', 'bido0.002_0.02']:
    # main(tag)
    main("rolss0.0_1")
