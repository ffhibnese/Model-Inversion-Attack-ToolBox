...
from modelinversion.models import IR152_64, VibWrapper
...
if __name__ == '__main__':
    ...
    model_name = 'ir152'
    vib_coef = 0.015
    save_name = f'celeba64_{model_name}_vib{vib_coef}.pth'
    dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/celeba_low'
    experiment_dir = f'../result_classifier/train_celeba64_{model_name}_vib{vib_coef}'
