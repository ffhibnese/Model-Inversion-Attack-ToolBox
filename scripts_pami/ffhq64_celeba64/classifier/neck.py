...
from modelinversion.datasets import CelebA64, CelebA112
...
def main(neck_dim):
    ...
    save_name = f'celeba64_{model_name}_neck{neck_dim}{neck_activation}.pth'
    dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/celeba_low'
    experiment_dir = f'../result_classifier/train_celeba64_{model_name}_neck{neck_dim}{neck_activation}'
    ...
    #     '/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_celeba64/result_classifier/train_celeba64_ir152_lora5_bak/celeba64_ir152_lora5.pth'
    # )
    ...
    train_dataset = CelebA64(
        ...
        output_transform=Compose(
            [
                ToTensor(),
                # RandomResizedCrop(64, (0.85, 1.0), antialias=True),
