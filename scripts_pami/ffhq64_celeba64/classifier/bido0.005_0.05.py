...
if __name__ == '__main__':
    ...
    ih_coef = 0.005
    oh_coef = 0.05
    save_name = f'celeba64_{model_name}_bido{ih_coef}_{oh_coef}.pth'
    dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/celeba_low'
    experiment_dir = (
        f'../result_classifier/train_celeba64_{model_name}_bido{ih_coef}_{oh_coef}'
    )
    ...
    config = BiDOTrainConfig(
        ...
        loss_fn=loss_fn,
        coef_hidden_input=ih_coef,
        coef_hidden_output=oh_coef,
    )
