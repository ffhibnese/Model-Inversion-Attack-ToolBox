...
if __name__ == '__main__':
    ...
    """
    stylegan2ada_path = (
        '/data/<usrname>/Model-Inversion-Attack-ToolBox/testresp/stylegan2-ada-pytorch'
    )
    stylegan2ada_ckpt_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/checkpoints_v2/stylegan2/stylegan2-ffhq-256x256.pkl'
    target_model_ckpt_path = (
        f'../result_classifier/train_celeba64_ir152_{tag}/celeba64_ir152_{tag}.pth'
    )
    ...
    optimize_batch_size = 40 * 2
    final_selection_batch_size = 40 * 2
