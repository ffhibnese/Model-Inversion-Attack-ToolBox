...
def main(tag, cuda_device):
    ...
    if tag == 'no':
        target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_celeba64/result_classifier/train_celeba64_ir152/celeba64_ir152.pth'
        tag = ''
    else:
        target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_celeba64/result_classifier/train_celeba64_ir152_{tag}/celeba64_ir152_{tag}.pth'

        tag = f'_{tag}'

    src_dataset_path = '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/ffhq64'
    dst_dataset_path = f'./dataset/plg_ffhq64_facescrub64_ir152{tag}_dataset'
    experiment_dir = f'./results_gan/plg_ffhq64_facescrub64_ir152{tag}_gan'
