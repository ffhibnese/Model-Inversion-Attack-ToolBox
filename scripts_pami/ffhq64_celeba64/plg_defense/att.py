...
def main(tag):
    ...
    if tag == 'no':
        ...
        tag = '_' + tag
    experiment_dir = f'./results_attack/plgmi_ir152{tag}'
    device_ids_str = '2'
    num_classes = 530
    generator_ckpt_path = f'./results_gan/plg_ffhq64_facescrub64_ir152{tag}_gan/G.pth'
    if tag == 'no':
        target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_celeba64/result_classifier/train_celeba64_ir152_/celeba64_ir152.pth'
    else:
        target_model_ckpt_path = f'/data/<usrname>/Model-Inversion-Attack-ToolBox/test_lora/ffhq64_celeba64/result_classifier/train_celeba64_ir152{tag}/celeba64_ir152{tag}.pth'
    eval_model_ckpt_path = (
        '../../../checkpoints_v2/classifier/celeba112/celeba112_facenet112_95.88.tar'
    )

    eval_dataset_path = (
        '/data/<usrname>/Model-Inversion-Attack-ToolBox/dataset/celeba_low/private_train'
    )
...
if __name__ == '__main__':
    ...
    # for tag in ['no', 'neck50tanh', 'ls0.12', 'tl0.6', 'vib0.01', 'bido0.002_0.02']:
    #     main(tag)
    main("rolss0.0_1")
