...
if __name__ == '__main__':
    ...
    lora_dim = 2
    ls_val = 0.01
    save_name = f'facescrub224_{model_name}_ls0.01.pth'
    dataset_path = '/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_ls0.01'
    backbone_path = '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_vit_b_16/pretrain_vit_b_16.pth'
    ...
    state_2_len = epoch_num // 4
    for i in range(state_2_len):
        trainer.loss_fn = LabelSmoothingCrossEntropyLoss(-ls_val * (i + 1) / state_2_len)
