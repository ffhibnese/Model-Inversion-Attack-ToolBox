...
if __name__ == '__main__':
    ...
    model_name = 'vit_b_16'
    lora_dim = 2
    save_name = f'facescrub224_{model_name}_neck50tanh.pth'
    dataset_path = '/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_neck50tanh'
    ...
    model = NeckWrapper(model, neck_dim=50)
