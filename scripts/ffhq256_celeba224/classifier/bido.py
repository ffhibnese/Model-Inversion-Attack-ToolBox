...
from modelinversion.models import TorchvisionClassifierModel, BiDOWrapper, BiDOWrapper, LoraWrapper
...
if __name__ == '__main__':
    ...
    model_name = 'vit_b_16'
    lora_dim = 2
    save_name = f'facescrub224_{model_name}_bido0.05_0.5.pth'
    dataset_path = '/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_bido0.05_0.5'
