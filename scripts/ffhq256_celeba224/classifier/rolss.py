...
if __name__ == '__main__':
    ...
    model_name = 'vit_b_16'
    lora_dim = 2
    save_name = f'celeba224_{model_name}_rolss0.01_1.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_celeba224_{model_name}_rolss0.01_1'
    ...
    model = SkipConnectionWrapper(model, residule_keep_ratio=0.01, erase_ratio_or_num=1)
