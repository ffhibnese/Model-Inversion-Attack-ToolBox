...
if __name__ == '__main__':
    ...
    model_name = 'maxvit_t'
    lora_dim = 2
    save_name = f'celeba224_{model_name}.pth'
    dataset_path = '/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_celeba224_{model_name}'
    backbone_path = '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_maxvit_t/pretrain_maxvit_t.pth'
