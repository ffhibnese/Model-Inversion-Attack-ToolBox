...
def main(tag):
    ...
    # tag = \
    #     'lora3_neck50tanh'
    experiment_dir = f'./result530/ppa_ir152{tag}'
    ...
    eval_model_ckpt_path = (
        '../result_classifier/train_facescrub224_maxvit_t/facescrub224_maxvit_t.pth'
    )
    eval2ckpt_path = '../result_classifier/train_facescrub224_inception_v3/facescrub224_inception_v3.pth'
    eval_dataset_path = '/mnt/data/<usrname>/datasets/facescrub/'
    attack_targets = list(range(530))
