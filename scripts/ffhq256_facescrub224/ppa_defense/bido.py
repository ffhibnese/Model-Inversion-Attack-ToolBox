...
if __name__ == '__main__':
    ...
    tag = 'bido0.01_0.1'
    experiment_dir = f'./ppa_ir152_{tag}'
    ...
    target_model_ckpt_path = f'/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub64_resnet152_bido_ih0.01_oh0.1/facescrub224_resnet152_bido_ih0.01_oh0.1.pth'
    # '/data/<usrname>/Model-Inversion-Attack-ToolBox/results/train_facescrub64_ir152_lora/facescrub64_ir152_lora.pth'
    eval_model_ckpt_path = '../result_classifier/train_facescrub64_maxvit_t/facescrub224_maxvit_t.pth'
    eval2ckpt_path = '../result_classifier/train_facescrub64_inception_v3/facescrub224_inception_v3.pth'
    eval_dataset_path = (
    ...
    eval_model2 = nn.parallel.DataParallel(eval_model2, device_ids=gpu_devices).to(device)
