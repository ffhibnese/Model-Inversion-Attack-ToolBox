...
if __name__ == '__main__':
    ...
    experiment_dir = f'./results_attack/plgmi_maxvit_t'
    device_ids_str = '2'
    num_classes = 530
    generator_ckpt_path = f'./results_gan/plg_ffhq256_facescrub256_resnet152_gan/G.pth'
    target_model_ckpt_path = f'/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub64_resnet152/facescrub224_resnet152.pth'
