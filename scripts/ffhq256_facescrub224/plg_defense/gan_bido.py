...
if __name__ == '__main__':
    ...
    dst_dataset_path = f'./dataset/plg_ffhq256_facescrub256_ir152_bido_ih0.05_oh0.5_dataset'
    experiment_dir = f'./results_gan/plg_ffhq256_facescrub256_ir152_bido_ih0.05_oh0.5_gan'
