...
if __name__ == '__main__':
    ...
    ls_val = 0.9
    save_name = f'facescrub224_{model_name}_pls{ls_val}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_pls{ls_val}'
    ...
    trainer.loss_fn = LabelSmoothingCrossEntropyLoss(ls_val)
