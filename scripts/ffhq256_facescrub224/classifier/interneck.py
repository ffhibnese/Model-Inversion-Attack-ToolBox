...
def main(neck_dim, neck_activation='tanh', cuda_devices='0', part_index_or_ratio=0.9):
    ...
    save_tag = f'facescrub224_{model_name}_interneck{neck_dim}_{part_index_or_ratio}'
    ...
    backbone_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_vgg16/pretrain_facescrub224_vgg16.pth'
