...
def main(dimension=256):
    ...
    encoder_path = f'/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub224_resnet152_neck{dimension}tanh/facescrub224_resnet152_neck{dimension}tanh.pth'
    encoder = auto_classifier_from_pretrained(encoder_path)

    for p in encoder.parameters():
        p.requires_grad = False

    decoder = SimpleGenerator256(530)
    ...
    train_dataset_noaug = FaceScrub224(
        '/mnt/data/<usrname>/datasets/facescrub/',
        train=True,
        output_transform=T.Compose(
            [
...
if __name__ == '__main__':
    ...
    dimensions = [20, 35, 40, 50, 75, 100, 150, 200, 300, 500]
