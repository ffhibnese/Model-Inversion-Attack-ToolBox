...
def main(tag):
    ...
    experiment_dir = f'./if_resnet152{tag}_v2'
    ...
    target_model_ckpt_path = f'../result_classifier/train_celeba224_resnet152{tag}/celeba224_resnet152{tag}.pth'
    # '/mnt/data/<usrname>/Model-Inversion-Attack-ToolBox/results/train_celeba64_ir152_lora/celeba64_ir152_lora.pth'
    eval_model_ckpt_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_celeba224/result_classifier/train_celeba224_maxvit_t/celeba224_maxvit_t.pth'
    # eval_model_ckpt_path_2 = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_celeba224/result_classifier/train_celeba224_maxvit_t/celeba224_maxvit_t.pth'
