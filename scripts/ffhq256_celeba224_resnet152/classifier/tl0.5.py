...
if __name__ == '__main__':
    ...
    lora_dim = 2
    save_name = f'facescrub224_{model_name}_tl0.8.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/pre_celeba_high'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_tl0.8'
    ...
    trainer.train(epoch_num, train_loader, test_loader, limit_acc=0.91)
