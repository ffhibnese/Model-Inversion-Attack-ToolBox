...
def main(ratio, neck_dim, cuda_device, print_terminal=False):
    ...
    add_tag = f'_lrc{ratio}_neck{neck_dim}tanh'
    ...
    model = NeckWrapper(model, neck_dim=neck_dim, neck_activation='tanh')
    # nn.Linear
    # model.compression()
