...
if __name__ == '__main__':
    ...
    model_name = 'ir152'
    tl_coef = 0.4
    save_name = f'facescrub64_{model_name}_tl{tl_coef}.pth'
    dataset_path = (
        '/mnt/data/<usrname>/intermediate-MIA/intermediate-MIA/data/facescrub'
    )
    experiment_dir = (
        f'../result_classifier/train_facescrub64_{model_name}_tl{tl_coef}_full'
    )
    # backbone_path = '/mnt/data/<usrname>/Model-Inversion-Attack-ToolBox/checkpoints_v2/classifier/backbones/Backbone_IR_152_Epoch_112_Batch_2547328_Time_2019-07-13-02-59_checkpoint.pth'
    ...
    model = IR152_64(num_classes, backbone_path=None)
