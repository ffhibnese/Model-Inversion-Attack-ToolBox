...
from modelinversion.models import TorchvisionClassifierModel, PostFilterWrapper
...
def main(
    ...
    save_dir = f'./results2/{dataset_builder.__name__}_{neck_dim}'
    ...
    if neck_dim is not None:
        model = PostFilterWrapper(model, down_rank=neck_dim)
...
if __name__ == '__main__':
    ...
    for builder in [CleanDataset]:
        ...
        main(builder, neck_dim=3)
        main(builder, neck_dim=4)
        main(builder, neck_dim=6)
        main(builder, neck_dim=8)
