...
if __name__ == '__main__':
    ...
    experiment_dir = f'./ppa_resnet152'
    ...
    target_model_ckpt_path = f'/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_nopretrain/result_classifier/train_facescrub224_resnet152/facescrub224_resnet152.pth'
