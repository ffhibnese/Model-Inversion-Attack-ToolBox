...
def main(tag, cuda):
    ...
    target_model_ckpt_path = f'/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_nopretrain/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
    ...
    sample_batch_size = 8 * 2
    optimize_batch_size = 6 * 2
    final_selection_batch_size = 4 * 2
    evaluation_batch_size = 4 * 2
    sample_num = 5000
    optimize_num = 20
    final_num = 5
...
if __name__ == '__main__':
    ...
    # time.sleep(1200)
    print('start')
    for tag in ['ftneck32tanh_focal8_lr2e-05_5']:
        # for tag in ['ls0.01_scheduler']:
        main(tag, 6)
