...
if __name__ == '__main__':
    ...
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_growlora{lora_dim}_{end_lora_dim}_st2end0.9'
    ...
    # print(load_res)
    model = GrowLoraWrapper(model, start_lora_dim=lora_dim, end_lora_dim=end_lora_dim, start_ratio=2, end_ratio=0.9)
