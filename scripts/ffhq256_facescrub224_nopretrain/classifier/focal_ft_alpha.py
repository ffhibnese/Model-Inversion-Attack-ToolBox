...
if __name__ == '__main__':
    ...
    add_tag = f'_focal{focal_p}_alpha{alpha}_lr{lr}_{ft_epoch}'
    ...
    optimizer = torch.optim.SGD(model.optim_nodes.parameters(), lr=lr, momentum=0.9)
    ...
    config = SimpleTrainConfig(
        ...
        loss_fn=InverseFocalLoss(focal_p, alpha=alpha),
    )
