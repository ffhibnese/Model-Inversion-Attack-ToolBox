...
if __name__ == '__main__':
    ...
    lora_dim = 1
    end_lora_dim = 20
    save_name = f'facescrub224_{model_name}_growlora{lora_dim}_{end_lora_dim}start2.pth'
    dataset_path = '/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_growlora{lora_dim}_{end_lora_dim}_st2'
    ...
    # print(load_res)
    model = GrowLoraWrapper(model, start_lora_dim=lora_dim, end_lora_dim=end_lora_dim, start_ratio=2)
