...
def main(focal_p, cuda_idx):
    ...
    src_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_nopretrain/result_classifier/train_facescrub224_resnet152_ftneck32tanh/facescrub224_resnet152_ftneck32tanh.pth'
    # focal_p = 8
    lr = 0.0002
    ft_epoch = 5
