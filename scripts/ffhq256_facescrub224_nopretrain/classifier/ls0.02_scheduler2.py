...
if __name__ == '__main__':
    ...
    ls_val = 0.02
    save_name = f'facescrub224_{model_name}_ls{ls_val}_scheduler_v2.pth'
    dataset_path = '/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_ls{ls_val}_scheduler_v2'
