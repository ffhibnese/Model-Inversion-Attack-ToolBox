...
def main(neck_dim, neck_activation='tanh', cuda_devices='0'):
    ...
    save_tag = f'facescrub224_{model_name}_neck{neck_dim}{neck_activation}'
    ...
    # model = auto_classifier_from_pretrained('/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_nopretrain/result_classifier/train_facescrub224_resnet152/facescrub224_resnet152.pth')
...
if __name__ == '__main__':
    cuda_devices = '0'
    main(40, cuda_devices=cuda_devices)