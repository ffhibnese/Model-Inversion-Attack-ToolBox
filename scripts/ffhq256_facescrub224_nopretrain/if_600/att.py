...
def main(tag):
    ...
    device_ids_available = '6'

    experiment_dir = f'./if_resnet152_{tag}'
    ...
    target_model_ckpt_path = f'/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_nopretrain/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
    # '/data/<usrname>/Model-Inversion-Attack-ToolBox/results/train_facescrub64_ir152_lora/facescrub64_ir152_lora.pth'
    eval_model_ckpt_path = '/data/<usrname>/mywork/lora_defense/checkpoints_v2/classifier/facescrub224/facescrub224_inception_v3_94.45.pth'
    eval_model_ckpt_path_2 = '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub64_maxvit_t/facescrub224_maxvit_t.pth'
    eval_dataset_path = (
    ...
    #     eval_model_ckpt_path, register_last_feature_hook=True, weights=None
    # )
    eval_model = TorchvisionClassifierModel(
        'inception_v3', num_classes=530, weights=None, register_last_feature_hook=True, operate_aux=False
    )
    ...
    eval_model_2 = nn.parallel.DataParallel(eval_model_2, device_ids=gpu_devices).to(device)
...
if __name__ == '__main__':
    tags = [
        ...
        'growlora1_20',
        # 'tl0.5',
        # 'growlora1_20_focal8_lr0.0001_5',
        # 'growlora1_20_focal8_lr1e-05_5'
        # 'growlora1_20_focal4_lr0.001_5',
        # 'growlora1_20_focal4_lr0.0001_10'
        # 'growlora1_20_focal4_alpha1_lr0.2_5'
        # 'growlora1_20_ls0.02_lr0.001_5'
        'growlora1_20_focal4_alpha1_lr0.002_ls-0.02_5'
    ]
    for tag in tags:
        main(tag)