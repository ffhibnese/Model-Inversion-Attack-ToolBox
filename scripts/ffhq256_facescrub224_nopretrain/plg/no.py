...
if __name__ == '__main__':
    ...
    loradim = 1
    tag = 'lora10'
    target_model_ckpt_path = f'../result_classifier/train_facescrub224_resnet152/facescrub224_resnet152.pth'
    src_dataset_path = '/data/<usrname>/datasets/ffhq256/'
    dst_dataset_path = f'./dataset/plg_ffhq256_facescrub256_resnet152_dataset'
    experiment_dir = f'./results_gan/plg_ffhq256_facescrub256_resnet152_gan'
