...
if __name__ == '__main__':
    ...
    # src_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub64_maxvit_t/facescrub224_maxvit_t.pth'
    tag = 'neck50tanh'
    src_path = f'/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/train_facescrub224_resnet152_{tag}/facescrub224_resnet152_{tag}.pth'
    ls_coef = 0.12
    lr = 0.00002
    ft_epoch = 5
    ...
    add_tag = f'_ls{ls_coef}_lr{lr}_{ft_epoch}'
    ...
    lr_schedular = torch.optim.lr_scheduler.MultiStepLR(
        optimizer, milestones=[int(ft_epoch * 0.6), int(ft_epoch * 0.8)], gamma=0.1
    )
    ...
    config = SimpleTrainConfig(
        ...
        loss_fn=LabelSmoothingCrossEntropyLoss(ls_coef),
    )
