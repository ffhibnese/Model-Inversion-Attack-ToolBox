...
from modelinversion.datasets import FaceScrub299
import torchvision
...
if __name__ == '__main__':
    ...
    experiment_dir = f'../result_classifier/train_facescrub64_{model_name}_v2'
    backbone_path = '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_inception_v3/pretrain_inception_v3.pth'
    ...
    model = TorchvisionClassifierModel(
        model_name, num_classes=num_classes, weights='DEFAULT', resolution=299
    )
    ...
    train_dataset = FaceScrub299(
        ...
        output_transform=Compose(
            [
                ToTensor(),
                RandomResizedCrop(
                    size=(299, 299), scale=(0.85, 1), ratio=(1, 1), antialias=True
                ),
