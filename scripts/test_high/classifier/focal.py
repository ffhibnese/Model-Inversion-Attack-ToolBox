...
def main(focal_gamma):
    num_classes = 530
    model_name = 'resnet152'
    tl_coef = 0.5
    # focal_gamma = 4
    save_name = f'facescrub224_{model_name}_tl{tl_coef}_focal{focal_gamma}.pth'
    dataset_path = '/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub64_{model_name}_tl{tl_coef}_focal{focal_gamma}'
