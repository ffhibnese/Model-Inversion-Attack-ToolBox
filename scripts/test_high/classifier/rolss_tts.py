...
def main(skip_coef, skip_num):
    ...
    save_name = f'facescrub224_{model_name}_rolss{skip_coef}_{skip_num}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub224_{model_name}_rolss{skip_coef}_{skip_num}'
