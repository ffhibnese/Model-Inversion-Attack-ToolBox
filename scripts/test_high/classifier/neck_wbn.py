...
def main(neck_dim, neck_activation='tanh', cuda_devices='0'):
    ...
    save_tag = f'facescrub224_{model_name}_neck{neck_dim}{neck_activation}_nobn'
    ...
    model = NeckWrapper(model, neck_dim=neck_dim, neck_activation=neck_activation, use_batch_norm=False)
    print(model)
