...
if __name__ == '__main__':
    ...
    lora_dim = 2
    tag = 'rolss0.1_1'
    save_name = f'facescrub224_{model_name}_{tag}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/facescrub/'
    experiment_dir = f'../result_classifier/train_facescrub64_{model_name}_{tag}'
    backbone_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_densenet169/pretrain_densenet169.pth'
    ...
    # freeze_front_layers(model, 0.8)
    model = SkipConnectionWrapper(model, residule_keep_ratio=0.1, erase_ratio_or_num=1)
    ...
    trainer.train(epoch_num, train_loader, test_loader, limit_acc=0.965)
