...
def main(tag):
    ...
    # '/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_densenet/result_classifier/train_facescrub64_densenet169_bido_ih0.05_oh0.5/facescrub224_densenet169_bido_ih0.05_oh0.5.pth'
    stylegan2ada_ckpt_path = '/mnt/data/<usrname>/mywork/lora_defense/checkpoints_v2/stylegan2ada/ffhq.pkl'
    target_model_ckpt_path = f'../result_classifier/train_facescrub64_densenet169{tag}/facescrub224_densenet169{tag}.pth'
