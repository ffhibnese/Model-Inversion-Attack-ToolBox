...
from modelinversion.models import auto_classifier_from_pretrained, VibWrapper
...
if __name__ == '__main__':
    ...
    save_name = f'pretrain_{model_name}_vib0.005.pth'
    dataset_path = '/data/<usrname>/datasets/msceleb1m/imgs'
    experiment_dir = f'../result_classifier/pretrain_{model_name}_vib0.005'
