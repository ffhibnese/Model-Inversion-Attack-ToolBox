...
def main(tag):
    ...
    experiment_dir = f'./attack/if_resnet152_{tag}'
    ...
    stylegan2ada_ckpt_path = '/mnt/data/<usrname>/mywork/lora_defense/checkpoints_v2/stylegan2ada/afhqdog.pkl'
    if tag == 'no':
        target_model_ckpt_path = f'/mnt/data/<usrname>/mywork/lora_defense/test_nips/dog/result_classifier/train_stanford_dogs_resnet152/stanford_dogs_resnet152.pth'
    else:
        target_model_ckpt_path = f"../result_classifier/train_stanford_dogs_resnet152_{tag}/stanford_dogs_resnet152_{tag}.pth"
    # '/mnt/data/<usrname>/Model-Inversion-Attack-ToolBox/results/train_facescrub64_ir152_lora/facescrub64_ir152_lora.pth'
    eval_model_ckpt_path = '/mnt/data/<usrname>/mywork/lora_defense/test_nips/dog/result_classifier/train_stanford_dogs_inception_v3/stanford_dogs_inception_v3.pth'
    eval_dataset_path = '/mnt/data/<usrname>/datasets/stanford_dogs/'
    attack_targets = list(range(100))

    sample_batch_size = 16
    optimize_batch_size = 12
...
if __name__ == '__main__':
    ...
    # tags = [20, 35, 75, 100, 150, 200, 300, 500]
    for tag in tags:
        main(tag)
