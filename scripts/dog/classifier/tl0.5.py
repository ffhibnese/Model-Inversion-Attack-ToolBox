...
if __name__ == '__main__':
    ...
    tl_coef = 0.3
    save_name = f'stanford_dogs_{model_name}_tl{tl_coef}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/stanford_dogs/'
    experiment_dir = (
        f'../result_classifier/train_stanford_dogs_{model_name}_tl{tl_coef}'
    )
    ...
    trainer.train(epoch_num, train_loader, test_loader, limit_acc=0.75)
