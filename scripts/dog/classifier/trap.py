...
if __name__ == '__main__':
    ...
    trap_alpha = 0.02
    trap_beta = 0.2
    save_name = f'stanford_dogs_{model_name}_trap{trap_alpha}_{trap_beta}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/stanford_dogs/'
    experiment_dir = f'../result_classifier/train_stanford_dogs_{model_name}_trap{trap_alpha}_{trap_beta}'
    backbone_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_stanford_dogs/result_classifier/pretrain_resnet152/pretrain_stanford_dogs_resnet152.pth'
    ...
    trainer.train(epoch_num, train_loader, test_loader, limit_acc=0.964)
