...
if __name__ == '__main__':
    ...
    ls_val = 0.001
    save_name = f'stanford_dogs_{model_name}_ls{ls_val}.pth'
    dataset_path = '/mnt/data/<usrname>/datasets/stanford_dogs/'
    experiment_dir = f'../result_classifier/train_stanford_dogs_{model_name}_ls{ls_val}'
