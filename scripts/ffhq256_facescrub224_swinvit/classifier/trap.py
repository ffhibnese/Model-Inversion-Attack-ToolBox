...
if __name__ == '__main__':
    ...
    backbone_path = '/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224/result_classifier/pretrain_swin_v2_t/pretrain_swin_v2_t.pth'
    ...
    trainer.train(epoch_num, train_loader, test_loader, limit_acc=0.97)
