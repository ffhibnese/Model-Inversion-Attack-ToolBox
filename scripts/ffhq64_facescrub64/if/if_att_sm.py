...
def main(tag, ccc):
    ...
    device_ids_available = f'0,1,2,3'

    experiment_dir = f'./attack_result_sm/if_ir152_{tag}'
    ...
    from modelinversion.utils.losses import poincare_loss

    def loss_fn_inner(outputs, targets):
        # return poincare_loss(x, y)
        outputs = torch.softmax(outputs, dim=-1)
        return poincare_loss(outputs, targets)

    loss_fn = ImageAugmentClassificationLoss(
        target_model,
        loss_fn=loss_fn_inner,
    ...
    attacker.evaluate_from_pre_generate(
        generator, list(range(1000)), description='alt1000', device=device
    )
...
if __name__ == '__main__':
    for tag in [
        'no'
        # 'neck30tanh_mse0.95_lr1_5',
        # 'neck30tanh_mse0.9_lr1_5',
        # 'neck30tanh_ls0.01_lr1_5',
        # 'neck30tanh_focal8_lr1_5',
        # 'neck30tanh_ls0.02_lr1_5',
        # 'neck30tanh_focal1_lr1_5',
        # 'neck30tanh_focal2_lr1_5',
        # 'neck30tanh_focal4_lr1_5',
        # 'neck30tanh_focal16_lr1_5',
        # 'neck30tanh_focal32_lr1_5',
        # 'neck30tanh_pls0.12_lr0.001_30'
        #   f'neck30tanh_focal{ttt}_lr0.01_5',
        #'neck30tanh_focal16_lr0.001_5',
        #'neck30tanh_focal32_lr0.001_5',
        # 'neck30tanh_focal4_lr0.01_5'
        #'neck30tanh_focal1_lr0.01_10',
        #'neck30tanh_focal2_lr0.01_10',
    ]:
        print(ttt, '<<<<<<<<<<<')
        main(tag, 1)
