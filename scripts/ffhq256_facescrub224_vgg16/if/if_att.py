...
def main(tag, ccc):
    ...
    device_ids_available = f'{ccc}'

    experiment_dir = f'./attack_result/if_vgg16_{tag}_v2'
    ...
    target_model_ckpt_path = f'../result_classifier/train_facescrub64_vgg16_{tag}/facescrub64_vgg16_{tag}.pth'
    # '/data/<usrname>/Model-Inversion-Attack-ToolBox/results/train_facescrub64_vgg16_lora/facescrub64_vgg16_lora.pth'
    ...
    sample_batch_size = 168
    optimize_batch_size = 80
