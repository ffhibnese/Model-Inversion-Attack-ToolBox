...
def main(cuda_devices='0'):

    num_classes = 530
    model_name = 'vgg16'

    save_tag = f'facescrub64_{model_name}_no_v2'
    ...
    model = auto_classifier_from_pretrained(
        "/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_vgg16/result_classifier/train_facescrub64_vgg16_no/facescrub64_vgg16_no.pth"
    )
    # state_dict = torch.load(backbone_path, map_location='cpu')["state_dict"]
...
if __name__ == '__main__':
    ...
    # for neck in necks:
    #     main(neck, neck_activation='sigmoid', cuda_devices=cuda_devices)
    main()
