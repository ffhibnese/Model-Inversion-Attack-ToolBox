...
def main(neck_dim, neck_activation='tanh', cuda_devices='0'):
    ...
    save_tag = f'facescrub64_{model_name}_neck{neck_dim}{neck_activation}_v2'
    ...
    backbone_path = "/mnt/data/<usrname>/mywork/lora_defense/test_lora/ffhq256_facescrub224_vgg16/result_classifier/train_facescrub64_vgg16_no/facescrub64_vgg16_no.pth"
    ...
    model = InterNeckWrapper(model, keep_rank_or_ratio=neck_dim)
    print(model)
...
if __name__ == '__main__':
    ...
    for neck in necks:
        main(neck, neck_activation='none', cuda_devices=cuda_devices)
