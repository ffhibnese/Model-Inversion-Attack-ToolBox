...
if __name__ == '__main__':
    ...
    mirror_blackbox_attack(genforce_name, target_name, eval_name, target_labels, work_dir, ckpt_dir, result_dir, batch_size=len(target_labels), device='cuda', calc_knn=calc_knn)